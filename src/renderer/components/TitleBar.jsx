  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: scale(8) }}>
        <svg width={scale(18)} height={scale(18)} viewBox="0 0 18 18" fill="none">
        ...
        <span style={{ fontSize: scale(12), fontWeight: 600, color: 'var(--text-secondary)', letterSpacing: '0.04em' }}>
      ...
      {api && (
        <div style={{ display: 'flex', gap: scale(6), WebkitAppRegion: 'no-drag' }}>
          {[
            ...
            <button
              ...
              onClick={action}
              style={{
                width: scale(28), height: scale(22),
                background: 'transparent',
                border: '1px solid var(--border)',
                borderRadius: 'var(--radius-sm)',
                color,
                fontSize: label === '□' ? scale(9) : scale(13),
